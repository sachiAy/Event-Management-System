		...
		<body background="./img/bc.jpg">
			<center>
				...
				<h1>Add Musicians</h1>
				 ...
				 <form class="form-box" action="music_add_submit.php" method="post" enctype="multipart/form-data">      
					<p>Enter ID:</p>
					...
					<a href="music_add_submit.php"><input class="form-button" type="submit" name="submit" value="Add Musician"></a>
