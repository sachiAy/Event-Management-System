    ...
    font-size: 16px;
		...
		<body background="./img/bc.jpg">
			<center>
				...
				<h1>Update Photographers</h1>
				
				 <form class="form-box" action="photographers_update_submit.php" method="post" enctype="multipart/form-data">      
					<p>Enter ID:</p>
					...
					<a href="photographers_update_submit.php"><input class="form-button" type="submit" name="submit" value="Update Photgrapher"></a>
